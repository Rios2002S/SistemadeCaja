...
class CustomPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 15, 'Reporte de Productos', 0, 1, 'L');
...
// Obtener los datos de los productos y agregarlos a la tabla
while ($producto = $resultProductos->fetch_assoc()) {
    $pdf->Cell(40, 10, $producto['id_producto'], 1, 0, 'C');
    $pdf->Cell(120, 10, $producto['nombre'], 1, 0, 'L');
    $pdf->Cell(40, 10, '$' . number_format($producto['precio'], 2), 1, 0, 'C');
    $pdf->Cell(40, 10, $producto['cantidad_en_stock'], 1, 1, 'C');
}
